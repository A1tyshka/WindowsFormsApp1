namespace LAB3_2D_PICTURES
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            button2.TabIndex = 1;
            button2.Text = "Бабиков Евдоким";
            button2.UseVisualStyleBackColor = true;
            button2.Click += button2_Click;
            // 
            // button3
            // 
            button3.Location = new Point(396, 41);
            button3.Name = "button3";
            button3.Size = new Size(134, 23);
            button3.TabIndex = 2;
            button3.Text = "Войцехов Эдуард";
            button3.UseVisualStyleBackColor = true;
            button3.Click += button3_Click;
            // 
            // button4
            // 
            button4.Location = new Point(571, 41);
            button4.Name = "button4";
            button4.Size = new Size(134, 23);
            button4.TabIndex = 3;
            button4.Text = "Федорук Антон";
